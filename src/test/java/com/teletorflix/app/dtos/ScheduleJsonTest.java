...
public class ScheduleJsonTest {
    ...
    private TvMazeScheduleDto getScheduleWithOneDay() {
        return TvMazeScheduleDto.of(List.of(DayOfWeek.THURSDAY), LocalTime.of(22, 0));
    }
    ...
    private TvMazeScheduleDto getScheduleWithTwoDays() {
        return new TvMazeScheduleDto(List.of(DayOfWeek.MONDAY, DayOfWeek.THURSDAY), LocalTime.of(22, 0));
    }
